...
const ContactForm = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 bg-white rounded-lg shadow-md mb-10 pt-10">
      <div className="text-center mb-8">
        <h2 className="text-5xl font-semibold text-gray-900">Let&apos;s Connect</h2>
        <p className="mt-4 text-gray-500">
          We&apos;re excited to connect with you and learn more about your real estate goals. Use the form below to get in touch with us.
        </p>
      </div>
