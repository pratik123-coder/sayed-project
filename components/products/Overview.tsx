      ...
      <div className="py-8 px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-black text-white rounded-md p-6 text-center">
            ...
            <p>Manage costs with categorized expenses, integrating payment interfaces, and enabling banking for professional oversight.</p>
          </div>
          <div className="bg-black text-white rounded-md p-6 text-center">
          ...
          <div className="bg-black text-white rounded-md p-6 text-center">
            ...
            <p>Integrate systems, digitize inventory, and manage assets with data-backed insights and analytics.</p>
          </div>
        </div>
      </div>
    </div>
