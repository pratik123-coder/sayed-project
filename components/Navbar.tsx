    ...
    <header className="fixed shadow-lg z-50 flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white text-sm py-4 dark:bg-neutral-800">
      ...
      >
        <div className="flex items-center justify-between gap-x-8">
          ...
          <div className="flex-none text-xl font-semibold dark:text-white flex gap-x-4 justify-center items-center">
            <Link
        ...
        >
          <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
            <Link
              className="font-medium text-gray-600 hover:text-gray-400 text-xl dark:text-neutral-400 dark:hover:text-neutral-500"
              href="#"
            >
              Raise Query
            </Link>
